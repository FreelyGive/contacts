...
class AddOrgForm extends AddContactBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['crm_org_name'] = $this->getWidget($profile, $profile_fields, 'crm_org_name', $form, $form_state);
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->profileViolations->filterByFields(['crm_org_name']);
  ...
  protected function buildEntities(array $form, FormStateInterface $form_state) {
    ...
    $profile->set('crm_org_name', $form_state->getValue('crm_org_name'));
  ...
  protected function flagViolations(array $form, FormStateInterface $form_state) {
    ...
    foreach ($this->profileViolations->getByField('crm_org_name') as $violation) {
      $form_state->setErrorByName('crm_org_name', $violation->getMessage());
    }
  }
