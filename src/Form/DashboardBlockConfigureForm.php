...
class DashboardBlockConfigureForm extends FormBase {
  ...
  public function updateBlock(array $form, FormStateInterface $form_state) {
    ...
    $response->addCommand(new ReplaceCommand("div[data-dnd-contacts-block-name='{$this->blockKey}'][data-dnd-block-mode!='meta']", $block_content));
    return $response;
  }
  ...
  public function removeBlock(array $form, FormStateInterface $form_state) {
    $response = new AjaxResponse();
    $response->addCommand(new RemoveCommand("div[data-dnd-contacts-block-name='{$this->blockKey}'][data-dnd-block-mode!='meta']"));
    return $response;
  }
